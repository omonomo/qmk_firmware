		...
		case MS_LEFT ... MS_ESC:
			if (IS_KEY_PRESS) {
				if (!IS_MOUSE_MODE) {
					...
					UNREGISTER_MOD_CODE_IF_ALONE(KC_LSFT, IS_ANY_MOD_PRESS);
					UNREGISTER_MOD_CODE_IF_ALONE(KC_RSFT, IS_ANY_MOD_PRESS);
					UNREGISTER_MOD_CODE_IF_ALONE(MET_KEY, IS_ANY_MOD_PRESS);
				} // IS_MOUSE_MODE
			} // IS_KEY_PRESS
		break;
